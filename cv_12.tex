...
\sectionspace
\fontspec[Path = fonts/raleway/]{Raleway-ExtraLight}\scriptsize{Looking for internships / coops starting Spring 2022 in security engineering, application security, penetration testing and red-teaming}
\end{flushleft}
