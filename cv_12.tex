...
\sectionspace
\fontspec[Path = fonts/raleway/]{Raleway-ExtraLight}\scriptsize{Looking for internships starting Summer 2022 in security engineering, application security, and offensive security}
\end{flushleft}
